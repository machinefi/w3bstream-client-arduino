...
#include "include/crypto/psa_crypto_storage.h"
#include "include/iotex/platform_util.h"

#if defined(IOTEX_PSA_ITS_FILE_C) || defined(IOTEX_PSA_ITS_FLASH_C) || defined(IOTEX_PSA_ITS_NVS_C)
#include "include/crypto/psa_crypto_its.h"
#else /* Native ITS implementation */
#include "include/svc/error.h"
#include "include/svc/internal_trusted_storage.h"
#endif
